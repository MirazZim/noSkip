...
export function MonthCalendarView({ expenses, month, onDayClick }: Props) {
  ...
  // Sort categories by spend for each day (for the mini stacked bar)
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    today ? "text-background" : isWeekend && !data ? "text-muted-foreground/50" : "text-foreground"
                  )}
                >
                  {format(day, "d")}
                </span>
                  ...
                  <>
                    ...
                    <div className="flex w-full mt-1.5 rounded-full overflow-hidden h-[3px] gap-[1px]">
                      {sortedCats.map(([cat, val]) => {
                        const catColor =
                          CATEGORY_COLORS[cat as ExpenseCategory] || CATEGORY_COLORS.Other;
                        ...
                        return (
                          <div
                            ...
                            style={{
                              width: `${pct}%`,
                              backgroundColor: today ? "rgba(255,255,255,0.5)" : catColor,
                            }}
                          />
                        );
                      })}
                ...
                {/* Hover tooltip with formatted total */}
                {data && !future && (
