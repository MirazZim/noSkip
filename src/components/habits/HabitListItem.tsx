    ...
    <>
      <style>{`
        ...
        .hi-swipe-btn {
          ...
          font-size: 9.5px; font-weight: 700; font-family: inherit;
        ...
        .hi-emoji-wrap {
          ...
          border-radius: 12px; background: hsl(var(--muted));
          display: flex; align-items: center; justify-content: center;
          font-size: 22px; line-height: 1; transition: filter 0.3s;
        }
